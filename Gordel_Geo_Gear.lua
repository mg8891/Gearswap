...
function init_gear_sets()
	...
	sets.midcast.Geomancy = {main="Idris",sub="Genmei Shield",range="Dunna",
		...
		body="Vedic Coat",hands="Geo. Mitaines +3",ring1="Defending Ring",ring2="Stikini Ring +1",
		back="Solemnity Cape",waist="Luminary sash",legs="Geomancy pants +3",feet="Medium's Sabots"}


	--Extra Indi duration as long as you can keep your 900 skill cap.
	sets.midcast.Geomancy.Indi = set_combine(sets.midcast.Geomancy, {back=gear.idle_jse_back,legs="Bagua Pants +2",feet="Azimuth Gaiters +1"})
    ...
    sets.midcast.Cure = {main="Gada",sub="Sors Shield",ammo="Hasty Pinion +1",
        ...
        back="Tempered Cape +1",waist="Witful Belt",legs="Geo. Pants +3",feet="Vanya Clogs"}
