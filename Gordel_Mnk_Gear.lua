...
function init_gear_sets()
	...
	sets.precast.WS = {ammo="Knobkierrie",
		...
		back="Segomo's Mantle",waist="Moonbow belt +1",legs="Hiza. Hizayoroi +2",feet=gear.herculean_ta_feet}
	...
	sets.idle = {ammo="Staunch Tathlum +1",
		head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Etheral Earring",
	...
	sets.engaged = {
		...
		waist="Moonbow Belt +1",
		legs="Samnuha Tights",
		feet={ name="Herculean Boots", augments={'Accuracy+15','"Triple Atk."+4','STR+9','Attack+6',}}
	}
		
		--This is the counter set
	...
	sets.engaged.Acc = {
		ammo="Aurgelmir orb +1",
		head="Malignance Chapeau", --"Ken. Jinpachi +1",
		neck="Monk's Nodowa +2",
		ear1="Telos earring",
		ear2="Sherida Earring",
		...
		back="Segomo's Mantle",
		waist="Moonbow belt +1",
		legs="Malignance Tights", --"Ken. Hakama +1",
		feet="Malignance Boots" --"Ken. Sune-Ate +1"
		}
