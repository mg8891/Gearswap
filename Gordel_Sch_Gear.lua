...
function init_gear_sets()
	...
	sets.TreasureHunter = set_combine(sets.TreasureHunter, {waist="Chaac Belt",body="Volte Jupon",feet=gear.chironic_treasure_feet})
    ...
    sets.midcast.Cure = {main="Serenity",sub="Curatio Grip",ammo="Hasty Pinion +1",
        ...
        body="Kaykaus Bliaut +1",hands="Peda. Bracers +3",ring1="Stikini Ring +1",ring2="Lebeche Ring",
        back="Tempered Cape +1",waist="Luminary Sash",legs="Chironic Hose",feet="Kaykaus Boots +1"}
		
    sets.midcast.LightWeatherCure = {main="Chatoyant Staff",sub="Curatio Grip",ammo="Hasty Pinion +1",
        head="Gende. Caubeen +1",neck="Incanter's Torque",ear1="Meili Earring",ear2="Malignance Earring",
        body="Kaykaus Bliaut +1",hands="Peda. Bracers +3",ring1="Janniston Ring",ring2="Lebeche Ring",
    ...
    sets.midcast.Kaustra = {main="Akademos",sub="Enki Strap",ammo="Pemphredo Tathlum",
        head="Pixie Hairpin +1",neck="Argute Stole +2",ear1="Crematio Earring",ear2="Malignance Earring",
    ...
    sets.midcast['Elemental Magic'] = {
		...
		sub={name="Ammurapi Shield",priority=14},
    ...
    sets.midcast['Elemental Magic'].Fodder = {main="Daybreak",sub="Ammurapi Shield",ammo="Dosis Tathlum",
        head=gear.merlinic_nuke_head,neck="Argute Stole +2",ear1="Crematio Earring",ear2="Friomisi Earring",
        body=gear.merlinic_nuke_body,hands="Mallquis Cuffs +2",ring1="Shiva Ring +1",ring2="Freke Ring",
    ...
    sets.midcast['Elemental Magic']['9k'] = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        head=gear.merlinic_nuke_head,neck="Argute Stole +2",ear1="Crematio Earring",ear2="Malignance Earring",
        body=gear.merlinic_nuke_body,hands="Mallquis Cuffs +2",ring1="Shiva Ring +1",ring2="Freke Ring",
        back="Swith Cape +1",waist="Witful Belt",legs="Psycloth Lappas",feet="Regal Pumps +1"}
	...
	sets.midcast.Helix = {
        ...
        head={ name="Merlinic Hood", augments={'Mag. Acc.+20 "Mag.Atk.Bns."+20','Magic burst dmg.+9%','INT+3',}},
		neck="Argute Stole +2",
		ear1="Regal earring",
		ear2="Malignance earring",
    ...
    sets.resting = {main="Chatoyant Staff",sub="Oneiros Grip",ammo="Homiliary",
		...
		body="Amalric Doublet",hands=gear.merlinic_refresh_hands,ring1="Defending Ring",ring2="Patricius ring",
		back="Moonlight cape",waist="Fucho-no-obi",legs="Assid. Pants +1",feet=gear.chironic_refresh_feet}


    -- Idle sets (default idle set not needed since the other three are defined, but leaving for testing purposes)

    sets.idle = {main="Malignance Pole",sub="Umbra Strap",ammo="Homiliary",
        head="Befouled Crown",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
        body="Jhakri Robe +2",hands=gear.merlinic_refresh_hands,ring1="Defending Ring",ring2="Stikini Ring +1",
        back="Moonlight cape",waist="Flax Sash",legs="Assid. Pants +1",feet={ name="Merlinic Crackows", augments={'Crit.hit rate+2','"Rapid Shot"+1','"Refresh"+1','Accuracy+6 Attack+6',}},}
    ...
    sets.idle.PDT = {main="Malignance Pole",sub="Umbra Strap",ammo="Staunch Tathlum +1",
        ...
        body="Vrikodara Jupon",hands="Gende. Gages +1",ring1="Defending Ring",ring2="Patricius ring",
    ...
    sets.idle.Weak = {main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
        head="Befouled Crown",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
        body="Jhakri Robe +2",hands=gear.merlinic_refresh_hands,ring1="Defending Ring",ring2="Patricius ring",
    ...
    sets.defense.PDT = {main="Malignance Pole",sub="Umbra Strap",ammo="Staunch Tathlum +1",
        head="Gende. Caubeen +1",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
        body="Mallquis Saio +2",hands="Gende. Gages +1",ring1="Defending Ring",ring2="Patricius ring",
    ...
    -- Normal melee group
    sets.engaged = {main="Malignance Pole",sub="Umbra Strap",ammo="Homiliary",
        head="Befouled Crown",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
        body="Jhakri Robe +2",hands=gear.merlinic_refresh_hands,ring1="Defending Ring",ring2="Stikini Ring +1",
        back="Moonlight cape",waist="Flax Sash",legs="Assid. Pants +1",feet={ name="Merlinic Crackows", augments={'Crit.hit rate+2','"Rapid Shot"+1','"Refresh"+1','Accuracy+6 Attack+6',}},}
    ...
    sets.HPCure = {main="Daybreak",sub="Sors Shield",range=empty,ammo="Hasty Pinion +1",
        ...
        body="Kaykaus Bliaut +1",hands="Peda. Bracers +3",ring1="Gelatinous Ring +1",ring2="Meridian Ring",
