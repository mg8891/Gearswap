function user_job_setup()
	...
	state.Weapons:options('None','Epeolatry','Lionheart','DualWeapons')
...
function init_gear_sets()
    ...
    sets.precast.JA['Swordplay'].DT = set_combine(sets.Enmity.DT,{hands="Futhark Mitons +2"})
    ...
    sets.precast.JA['Vivacious Pulse'] = {head="Erilaz Galea +1",neck="Incanter's Torque",back="Altruistic cape",waist="Bishop's sash",ear1="Beatific earring",ring1="Stikini Ring +1",ring2="Stikini Ring +1",legs="Rune. Trousers +3"}
    ...
    sets.precast.WS['Dimidiation'] = set_combine(sets.precast.WS,{
		...
		back={ name="Ogma's cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+6','Weapon skill damage +10%','Phys. dmg. taken-10%',}},})
    ...
    sets.midcast.FastRecast = {ammo="Impatiens",
            ...
            body="Dread Jupon",hands="Leyline Gloves",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
            back="Moonlight Cape",waist="Flume Belt +1",legs="Rawhide Trousers",feet="Carmine Greaves +1"}
			
	sets.midcast.FastRecast.DT = {ammo="Staunch Tathlum +1",
        head="Fu. Bandeau +3",neck="Futhark Torque +2",ear1="Odnowa Earring +1",ear2="Tuisto Earring",
        body="Runeist's Coat +3",hands="Kurys Gloves",ring1="Gelatinous Ring +1",ring2="Moonlight Ring",
	...
	sets.midcast['Refresh'] = set_combine(sets.midcast['Enhancing Magic'],{legs="Futhark Trousers +3",head="Erilaz Galea +1"}) 
    ...
    sets.idle = {
		...
		feet={ name="Herculean Boots", augments={'Damage taken-2%','Sklchn.dmg.+3%','"Refresh"+2','Mag. Acc.+19 "Mag.Atk.Bns."+19',}},}
	...
	sets.idle.Weak = {main="Epeolatry",sub="Utu Grip",ammo="Homiliary",
		head="Rawhide Mask",neck="Futhark Torque +2",ear1="Genmei Earring",ear2="Ethereal Earring",
	...
	sets.defense.BDT = {main="Epeolatry",sub="Utu Grip",ammo="Staunch Tathlum +1",
        ...
        body="Runeist's Coat +3",hands="Kurys Gloves",ring1="Defending Ring",ring2="Shadow Ring",
    ...
    sets.engaged.SomeAcc = {main="Lionheart",sub="Utu Grip",ammo="Yamarang",
            ...
            body="Ashera Harness",hands="Adhemar Wrist. +1",ring1="Niqmaddu Ring",ring2="Epona's Ring",
	...
	sets.engaged.HighAcc = {main="Lionheart",sub="Utu Grip",ammo="C. Palug Stone",
            ...
            body="Ashera Harness",hands="Meg. Gloves +2",ring1="Niqmaddu Ring",ring2="Ilabrat Ring",
	...
	sets.engaged.FullAcc = {
            ...
            body="Ashera Harness",
			hands="Turms Gloves +1",
			ring1="Ramuh Ring +1",
			ring2="Ramuh Ring +1",
            back=gear.stp_jse_back,
			waist="Kentarch Belt +1",
			legs="Turms Leggings +1",
    ...
    sets.engaged.SomeAcc.DTLite = {main="Lionheart",sub="Utu Grip",ammo="C. Palug Stone",ammo="C. Palug Stone",
            head="Aya. Zucchetto +2",neck="Futhark Torque +2",ear1="Cessance Earring",ear2="Sherida Earring",
	...
	sets.engaged.Acc.DTLite = {main="Lionheart",sub="Utu Grip",ammo="C. Palug Stone",ammo="C. Palug Stone",
            head="Aya. Zucchetto +2",neck="Futhark Torque +2",ear1="Telos Earring",ear2="Sherida Earring",
            body="Ayanmo Corazza +2",hands="Meg. Gloves +2",ring1="Defending Ring",ring2="Patricius Ring",
    ...
    sets.engaged.Tank = {main="Epeolatry",sub="Utu Grip",ammo="Staunch Tathlum +1",
            head="Meghanada Visor +2",neck="Futhark Torque +2",ear1="Genmei Earring",ear2="Ethereal Earring",
            body="Futhark Coat +3",hands="Kurys Gloves",ring1="Defending Ring",ring2="Shadow Ring",
            back="Moonlight Cape",waist="Flume Belt +1",legs=gear.herculean_dt_legs,feet="Erilaz Greaves +1"}
	sets.engaged.Tank_HP = {main="Epeolatry",sub="Utu Grip",ammo="Staunch Tathlum +1",
        head="Fu. Bandeau +3",neck="Futhark Torque +2",ear1="Odnowa Earring +1",ear2="Etheral Earring",
        body="Runeist's Coat +3",hands="Kurys Gloves",ring1="Defending Ring",ring2="Moonlight Ring",
        back="Moonlight Cape",waist="Flume Belt +1",legs="Eri. Leg Guards +1",feet="Erilaz Greaves +1"}
	...
	sets.buff.Battuta = {hands="Turms Mittens +1",legs="Erilaz leg guards +1",feet="Turms Leggings +1"}
