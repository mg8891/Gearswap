...
function init_gear_sets()
    ...
    sets.engaged = {ammo="Aurgelmir Orb +1",
        head="Dampening Tam",neck="Anu Torque",ear1="Dedition earring",ear2="Sherida Earring",
        body="Adhemar Jacket +1",hands="Adhemar Wrist. +1",ring1="Gere Ring",ring2="Epona's Ring",
        back="Toutatis's Cape",waist="Reiki Yotai",legs="Samnuha Tights",feet=gear.herculean_ta_feet}
