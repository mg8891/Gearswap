...
function init_gear_sets()
	...
	sets.resting = {main="Bolelabunga",sub="Genmei Shield",ammo="Falcon Eye",
			      head={ name="Herculean Helm", augments={'"Refresh"+2'}},neck="Loricate Torque +1",ear1="Etiolation Earring", ear2="Ethereal Earring",
	...
	sets.idle = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum +1",
			      head={ name="Herculean Helm", augments={'"Refresh"+2'}},neck="Loricate Torque +1",ear1="Etiolation Earring", ear2="Ethereal Earring",
			      body="Jhakri Robe +2",hands="Assim. Bazu. +3",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
			      back="Moonlight cape",waist="Flume Belt +1",legs="Lengo Pants",head={ name="Herculean Boots", augments={'"Refresh"+2'}},}
